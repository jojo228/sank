...
class RoomAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            "Basic Info",
            {"fields": ("nom", "room_type", "description", "adresse", "prix_par_nuit", "prix_par_semaine", "prix_par_mois", "caution", "video")},
        ),
    ...
    ordering = ("nom", "prix_par_nuit", "prix_par_semaine", "prix_par_mois", "caution", "nombre_de_chambres")
